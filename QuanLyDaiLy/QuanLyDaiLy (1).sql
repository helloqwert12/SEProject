...
INSERT INTO PHIEUXUAT VALUES('PX001','DL001','30/04/2017', 22000)
...
------------------------test
SELECT BAOCAODOANHSO.MaDaiLy, TenDaiLy, ThoiGian, SoPhieuXuat, PHIEUXUAT.TongTriGia, TyLe 
FROM BAOCAODOANHSO join DAILY on BAOCAODOANHSO.MaDaiLy = DAILY.MaDaiLy join PHIEUXUAT on DAILY.MaDaiLy = PHIEUXUAT.MaDaily
WHERE NgayLapPhieu >= '01/10/2013' AND NgayLapPhieu <= '31/5/2017' --Month(NgayLapPhieu) = cbThang.SelectedIndex and Year(NgayLapPhieu) = txbNam.Text
